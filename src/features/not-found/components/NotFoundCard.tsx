...
export function NotFoundCard() {
  return (
    <AppCard
      className="w-full rounded-[2rem] px-6 py-10 shadow-[0_20px_36px_var(--rgba-31-37-31-008)]"
      padding="none"
    >
      ...
      <p className="mt-5 text-xs uppercase tracking-[0.32em] text-[var(--color-accent-gold)]">
        404
      </p>
