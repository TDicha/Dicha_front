...
export function ProfileCard({ user }: { user: UserProfile }) {
  return (
    <AppCard className="overflow-hidden rounded-[1.65rem] shadow-[0_16px_30px_var(--rgba-31-37-31-007)]" padding="none">
      <div className="bg-[linear-gradient(135deg,var(--color-primary-green),var(--palette-315a40))] px-5 py-5 text-white">
