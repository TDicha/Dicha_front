...
2026-06-07 기준 Dicha Coffee 프론트엔드 워크스페이스입니다. 모바일 퍼스트 PWA 고객 앱과 관리자 콘솔을 함께 관리하는 pnpm/turbo 모노레포로 구성되어 있으며, Spring Boot 백엔드 REST API와 연동하는 방향으로 제작 중입니다.
...
- PWA: manifest, service worker 자동 업데이트, 설치 프롬프트 훅
...
- `installPromptStore`: PWA 설치 프롬프트 상태
