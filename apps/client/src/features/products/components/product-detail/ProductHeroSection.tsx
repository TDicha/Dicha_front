...
export function ProductHeroSection({
  ...
  return (
    <section className="relative min-h-[clamp(17.5rem,58vh,22rem)] overflow-hidden bg-[var(--surface-chalkboard)]">
      <img
        alt={productName}
      ...
      <div className="absolute inset-x-3 bottom-3 bg-[var(--surface-chalkboard)] px-3 py-2 text-left">
        <p className="text-[0.62rem] font-semibold tracking-[0.16em] text-[var(--text-chalk-muted)]">
          TODAY&apos;S MENU
        </p>
        <p className="mt-1 truncate text-sm font-semibold text-[var(--text-chalk)]">
          {productName}
        </p>
      </div>
    </section>
