  ...
  return (
    <div className="bg-[var(--surface-base)] px-5 pb-10 pt-4">
      <section className="px-1 pb-10 pt-28 text-center">
        ...
        <h2 className="mt-10 text-[2.1rem] font-bold tracking-[-0.04em] text-[var(--text-heading)]">
          저장된 블렌드가 없습니다
        </h2>
        <p className="mt-4 text-[1.15rem] leading-8 text-[var(--text-muted-warm)]">
      ...
      <section className="rounded-[1.5rem] bg-[var(--surface-warm-page)] px-5 py-5">
        <div className="flex items-start gap-3">
          <div className="mt-1 rounded-[0.4rem] bg-[var(--brand-accent-strong)] p-1 text-[var(--surface-cream-light)]">
            <QrCode className="size-4" />
          </div>
          <div>
            <h3 className="text-[1.45rem] font-bold tracking-[-0.03em] text-[var(--brand-primary-soft)]">
              매장 QR로도 저장 가능!
            </h3>
